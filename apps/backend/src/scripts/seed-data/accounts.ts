...
/**
 * Demo accounts for the Contract Management → Account module, covering
 * every account type and both statuses. The business ids (ACC-…) are the
 * keys the contract line seeds resolve their owners by — keep them in sync
 * with {@link ../seed-data/contract-lines.ts}.
 */
